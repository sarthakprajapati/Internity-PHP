...
$t=array("Sarthak"=>"Prajapati","Age"=>21,"Hobbies"=>"Programming");
...
$g= array("1"=>"one","2"=>"two","3"=>"three","4"=>"four","5"=>"five","6"=>"six","7"=>"seven","8"=>"eight");
...
echo("<br><br>");
$q=array(1=>"one",2=>"two",3=>"three",4=>"four");
$w=array(2=>"two",3=>"three",5=>"five");
...
if (array_key_exists("Volvo",$r))
 ...
 //array_keys()
  ...
  //array_multisort()
$kj=array(1,30,15,7,25);
$kl=array(4,30,20,41,66);
...
//array_rand
$gh=array("red","green","blue","yellow","brown");
...
//array_search()
echo("<br><br>");
$at=array("a"=>"red","b"=>"green","c"=>"blue");
echo array_search("red",$at);
//array_shift()
$aq=array("a"=>"red","b"=>"green","c"=>"blue");
echo array_shift($aq);
print_r ($aq);
//array_slice()
echo("<br><br>");
